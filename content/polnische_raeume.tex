...
\begin{document}
	...
	\begin{proof}
		Wir zeigen zunächst, dass jede $G_\delta$-Teilmenge von $\X$ polnisch ist und orientieren und dabei an \cite[Theorem 7]{JordanBell.2014}. Der Beweis, den wir anschließend für 
		...
		\[y_k \in \bigcap_{j=1}^{k} B_{1/j}(x_{m_j})\]
		gilt, ist $(y_k)_k$ eine Cauchyfolge bezüglich $d'$. Aufgrund der Vollständigkeit von 
