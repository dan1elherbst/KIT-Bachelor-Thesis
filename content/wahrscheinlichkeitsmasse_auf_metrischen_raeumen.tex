...
\begin{document}
	...
	\begin{Bemerkung}[Beziehung zur Schwach-$\ast$-Konvergenz]
		...
		Sind $\Finitemeasures{X}$ bzw. $\Bdcontfct{X}^\ast$ mit der Topologie der schwachen Konvergenz bzw. mit der 
		...
		Handelt es sich bei $X$ nun um einen metrischen Raum, so ist $\Phi$ injektiv: 
		Satz~\ref{thm:measureequality} (ii) ermöglicht es uns nämlich, 
		für $\mu, \nu \in \Finitemeasures{X}$ aus $l_\mu = l_\nu$ die Gleichheit $\mu = \nu$ zu schließen. 
		Daraus folgt insbesondere, dass $\Phi$ in diesem Fall sogar ein Homöomorphismus auf sein Bild ist.
		
		Unter etwas spezielleren Voraussetzungen können mittels dieser Identifikation Aussagen aus der 
