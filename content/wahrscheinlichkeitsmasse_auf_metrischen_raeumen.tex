...
\begin{document}
	...
	\begin{proof}
		...
		Der Rieszsche Darstellungssatz liefert nun die Bijektivität von $\Phi$ und aus den vorigen Überlegungen ergibt sich, dass $\Phi$ ein Folgen-Homöomorphismus zwischen $\Probmeasures{X}$ und $A$ ist. Nach dem Satz
		...
		Also ist auch $\Probmeasures{X}$ folgenkompakt.
	\end{proof}
