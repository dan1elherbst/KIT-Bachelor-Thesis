...
\begin{document}
	...
	\begin{proof}
		...
		Offenbar ist $l$ wohndefiniert und linear. Da $l(f) \leq C \norm{f}_\infty$ für alle $f \in \Bduniffct{X}$ gilt, folgt $l \in A^\ast$. Nach dem Satz von \tobechanged{Hahn-Banach}
		...
		nach dem Darstellungssatz von \tobechanged{Riesz-Markov} ein Maß $\mu \in \Finitemeasures{X}$ mit 
	...
	\begin{proof}
		...
		Der Darstellungssatz von \tobechanged{Riesz-Markov} liefert die Bijektivität von $\Phi$, also ist $\Phi$ ein 
