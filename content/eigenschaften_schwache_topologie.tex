...
\begin{document}
	...
	In Teilabschnitt~\ref{subsec:straffheit_prokhorov} findet sich mit dem \emph{Satz von Prokhorov} eine sehr hilfreiche Charakterisierung der Kompaktheit von Teilmengen von $\Probmeasures{\X}$.
