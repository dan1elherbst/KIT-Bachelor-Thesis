...
\begin{document}
	...
	\begin{proof}
		...
		\[ \mu(\bigcup_{n=1}^{m_\delta} B_\delta(x_n)) \; > \; 1 - \delta \label{glg:5.5} \tag{5.5} \]
		...
		\[ \mu_m(\bigcup_{n=1}^{m} B_\delta(x_n)) \; \leq \; 1 - \delta \text{.} \]
		Insbesondere bedeutet das natürlich auch, dass wir für alle $m \in \N$ und $k \geq m$ 
		\[ \mu_k(\bigcup_{n=1}^{m} B_\delta(x_n)) \; \leq \; 1 - \delta \]
		...
		\[ \mu(\bigcup_{n=1}^{m} B_\delta(x_n)) 
		\; \leq \; \liminf_{j \to \infty} \mu_{k_j}(\bigcup_{n=1}^{m} B_\delta(x_n)) 
