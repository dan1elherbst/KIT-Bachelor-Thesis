...
\begin{document}
	...
	\begin{proof}
		...
		mit der Schwach-$\ast$-Topologie. Mit dem Satz von Banach-Alaoglu (siehe etwa \cite[Satz 5.8.1]{Simon.2015}) folgt nun, dass $A$ als abgeschlossene Teilmenge der kompakten Menge 
	...
	\begin{Bemerkung}
		...
		in diesem Fall vollständig durch konvergente Folgen charakterisiert wird. Wir müssen im weiteren Verlauf (bei metrisierbarem und separablem $X$) also nicht mehr mit dem Konzept der Netze arbeiten, dass wir zu Beginn eingeführt haben. Stattdessen
		können einfach immer Folgen verwenden, um Stetigkeit, Abgeschlossenheit, etc. nachzuweisen.
	\end{Bemerkung}
