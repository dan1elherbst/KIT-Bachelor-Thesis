...
\begin{document}
	...
	\begin{Bemerkung}
		...
		(für Satz~\ref{thm:finitemeasurespolish} folgt die Hinrichtung dann etwa aus der Abgeschlossenheit von $\Probmeasures{X} \subseteq \Finitemeasures{X}$ unter Verwendung von Hilfssatz~\ref{lem:opensets}).
	\end{Bemerkung}
