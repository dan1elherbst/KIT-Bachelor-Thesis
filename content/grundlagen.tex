...
\begin{document}
	...
	\begin{Proposition}[Konvergenz bezüglich der Initialtopologie]
	...
	Für den Beweis des Satzes benötigen wir noch zwei Hilfsaussagen. 
	Die folgende Proposition behandelt die recht elementare Tatsache, dass sich in metrischen Räumen 
	...
	Der anschließende Hilfssatz, den wir vorstellen,
	...
	\begin{Proposition}
		\label{proposition:offene_mengen}
	...
	\begin{proof}
		Diese Proposition entspricht \cite[Lemma 4.14.1]{Simon.2015}.
	...
	Ausgestattet mit Proposition~\ref{proposition:offene_mengen} und Hilfssatz~\ref{hilfssatz:schwach_reguläre_mengen_sigma_algebra} können wir jetzt zum Beweis von Satz~\ref{satz:schwache_regularität} 
	übergehen.
	...
	\begin{proof}[Beweis von Satz~\ref{satz:schwache_regularität}]
		...
		Proposition~\ref{proposition:offene_mengen}. 
	...
	\begin{proof}
		Wir führen den Beweis aus \cite[Theorem 4.14.3]{Simon.2015}.
		...
		Dann gilt für die Funktionen $f_n \in \Bdlipschitzfct{\X}$ aus Proposition~\ref{proposition:offene_mengen}
