...
\begin{document}
	...
	\emph{Regularität} bzw. \emph{schwachen Regularität} eine grundlegende Approximationseigenschaft für Maße auf topologischen Räumen ansehen werden.
	...
	Überwiegend orientieren wir uns in diesem Teilabschnitt an \cite[Kapitel 2.6]{Simon.2015}.
	...
	\begin{Bemerkung}
		...
		von endlich vielen $\iota \in I$ zu finden und damit ähnlich zu argumentieren, als würden wir gerade mit Folgen arbeiten.
	\end{Bemerkung}
	...
	Der erste (Hilfssatz~\ref{lem:opensets}) behandelt die recht elementare Tatsache, dass sich in metrischen Räumen 
	...
	Ausgestattet mit den Hilfssätzen \ref{lem:opensets} und \ref{lem:sigmaalg} können wir jetzt zum Beweis von Satz~\ref{thm:weakregularity} 
	übergehen.
