...
\begin{document}
	...
	\begin{Proposition}
		...
		\begin{enumeratethm}
			...
			$x = (x_\iota)_{\iota \in I}$ in $C$ ebenfalls in $C$ liegt.
	...
	\begin{proof}
		...
		anstelle \enquote{schwach regulär} für kompaktes $\X$ bewiesen wird. Im folgenden Beweis sei $\mathcal{O}$ die Topologie von $\X$.
