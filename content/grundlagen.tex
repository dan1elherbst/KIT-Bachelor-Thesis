...
\begin{document}
	...
	\begin{proof}
		...
		$(A, \tilde{d})$ gibt es also ein $y \in X$ mit $y_k \to y$, was 
	...
	separable bzw. polnische Räume führen, benötigen hierfür aber zunächst noch einen Hilfssatz.
	...
	\begin{proof}[Beweis von Satz~\ref{thm:characterizationpolishspaces}]
		...
		gesehen haben, dass jeder separable metrisierbare Raum homöomporph zu einer 
