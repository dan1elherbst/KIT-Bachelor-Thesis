...
\begin{document}
	...
	Überwiegend orientiert sich dieser Abschnitt an \cite[Kapitel 2.6]{Simon.2015}.
	...
	\begin{Bemerkung}
		...
		\end{align*}
		sofern die Summen jeweils definiert sind.
	...
	\begin{proof}
		...
		\cite[Lemma 4.5.5]{Simon.2015} vor, wo die entsprehende Aussage mit \enquote{Regularität} 
		anstelle \enquote{schwacher Regularität} für kompakte $X$ bewiesen wird.
