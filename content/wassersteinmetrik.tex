...
\begin{document}
	...
	Für die Motivation des optimalen Transports orientieren wir uns an \cite{Monge.1781}, mit der Monge im Jahr 1781 das Gebiet begründete.  
	...
	Im Folgenden wird nun nicht die mathematische Formalisierung des optimalen Transports von Monge präsentiert, sondern eine alternative Formulierung, die Kantorovich in seiner Arbeit \cite{Kantorovich.2006} im Jahr 1942 zuerst vorstellte.
	Zunächst sehen wir uns an, wie mittels \emph{Kopplungen} ein Transportplan zwischen zwei Masseverteilungen $\mu$ und $\nu$ modelliert werden kann, der spezifiziert, woher wie viel Masse wohin transportiert werden soll.
	...
	\begin{Beispiel}[$W_2$-Distanz von Normalverteilungen]
		...
		$\lambda_1,\lambda_2 \in \R$ und Varianzen $\sigma_1^2,\sigma_2^2 \in (0, \infty)$. Wir möchten $W_2(\mu_1, \mu_2)$ berechnen. Hierbei orientieren wir uns an \cite[Remark 2.31 und Figure 2.14]{Peyre.2019}.
