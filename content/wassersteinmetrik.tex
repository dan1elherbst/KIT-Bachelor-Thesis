...
\begin{document}
	...
	\begin{Beispiel}[$W_2$-Distanz von Normalverteilungen]
		...
		\[ W_2(\mu_1, \mu_2) \; = \; \left(\inf_{\pi \in \Pi(\mu_1, \mu_2)} \measureintx{\R^2}{\abs{x-y}^2}{\pi}{(x, y)}\right)^{\! 1/2} \; = \; \norm{\begin{pmatrix} \lambda_1 \\ \sigma_1 \end{pmatrix} - \begin{pmatrix} \lambda_2 \\ \sigma_2 \end{pmatrix}}_2 \text{,} \]
		und die Abbildung
	...
	Außerdem ist noch ein letzter Hilfssatz von Nöten, in dessen Beweis die obige Dualitätsformel eingeht.
