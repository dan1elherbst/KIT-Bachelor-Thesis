...
\begin{document}
	...
	\begin{proof}[Beweis von Satz~\ref{thm:wassersteinweakconvergence}]
		...
		Nach \tobechanged{TODO} ist jedes $\tilde{\pi}_l$ eine optimale Kopplung von $\mu$ und $\mu$, also muss es sich bei $\tilde{\pi}_l$ um die triviale Kopplung $\pi$ handeln, die durch
