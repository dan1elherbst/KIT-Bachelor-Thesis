...
\begin{document}
	...
	\tobechanged{Das würde ich gerne zeigen, in diesem Beweis wird allerdings nur gezeigt, 
	...
	\begin{proof}
		...
		$\setcomp{l \in C_b(X)^\ast}{\norm{l}_{\Bdcontfct{X}^\ast} \leq 1}$ kompakt bezüglich der Schwach-$\ast$-Topologie und \tobechanged{damit auch folgenkompakt}.
